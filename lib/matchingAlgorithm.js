...
var thetas = {winLossRatio: 1, winVelocity: 1.2, rank: 1.5, winStreak: 0.7};
...
var findOpponent = function ( playerObj, otherPlayers, features, badMatches) {
  ...
  otherPlayersKeys.forEach( function ( name) {
    ...
    if ( Math.abs(player.rank - playerObj.rank) <= rankMargin && !badMatches[playerObj][player] ) {
